...
//			throws QingCloudClientException, QingCloudServiceException, IOException;
    ...
    public DeleteTagsResponse deleteTags(
            DeleteTagsRequest deleteTagsRequest)
            throws QingCloudClientException, QingCloudServiceException, IOException;

    public ModifyTagAttributesResponse modifyTagAttributes(
            ModifyTagAttributesRequest request)
            throws QingCloudClientException, QingCloudServiceException, IOException;
    ...
    public DetachTagsResponse detachTags(
            DetachTagsRequest request)
            throws QingCloudClientException, QingCloudServiceException, IOException;
