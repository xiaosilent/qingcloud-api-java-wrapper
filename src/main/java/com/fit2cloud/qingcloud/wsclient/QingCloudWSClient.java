...
public class QingCloudWSClient implements IQingCloudWSClient {
    ...
    public DescribeTagsResponse describeTags(DescribeTagsRequest describeTagsRequest) throws QingCloudClientException, QingCloudServiceException, IOException {
        DescribeTagsResponse describeTagsResponse = null;
        String httpMethod = "GET";
        String action = QingCloudAction.DESCRIBE_TAGS;
        try {
            String jsonResponse = this.sendRequest(httpMethod, action, describeTagsRequest);
    ...
    public DeleteTagsResponse deleteTags(DeleteTagsRequest deleteTagsRequest) throws QingCloudClientException, QingCloudServiceException, IOException {
        DeleteTagsResponse response = null;
        String httpMethod = "GET";
        String action = QingCloudAction.DELETE_TAGS;
        try {
            String json = this.sendRequest(httpMethod, action, deleteTagsRequest);
            response = DeleteTagsResponse.fromJson(json);
        } catch (QingCloudClientException e) {
            throw e;
        } catch (QingCloudServiceException e) {
            throw e;
    ...
    public ModifyTagAttributesResponse modifyTagAttributes(ModifyTagAttributesRequest request) throws QingCloudClientException, QingCloudServiceException, IOException {
        ModifyTagAttributesResponse response = null;
        String httpMethod = "GET";
        String action = QingCloudAction.MODIFY_TAG_ATTRIBUTES;
        try {
            String json = this.sendRequest(httpMethod, action, request);
            response = ModifyTagAttributesResponse.fromJson(json);
        } catch (QingCloudClientException e) {
            throw e;
        } catch (QingCloudServiceException e) {
            throw e;
    ...
    public AttachTagsResponse attachTags(AttachTagsRequest request) throws QingCloudClientException, QingCloudServiceException, IOException {
        AttachTagsResponse response = null;
        String httpMethod = "GET";
        String action = QingCloudAction.ATTACH_TAGS;
        try {
            String json = this.sendRequest(httpMethod, action, request);
            response = AttachTagsResponse.fromJson(json);
        } catch (QingCloudClientException e) {
            throw e;
        } catch (QingCloudServiceException e) {
            throw e;
    ...
    public DetachTagsResponse detachTags(DetachTagsRequest request) throws QingCloudClientException, QingCloudServiceException, IOException {
        DetachTagsResponse response = null;
        String httpMethod = "GET";
        String action = QingCloudAction.DETACH_TAGS;
        try {
            String json = this.sendRequest(httpMethod, action, request);
            response = DetachTagsResponse.fromJson(json);
        } catch (QingCloudClientException e) {
            throw e;
        } catch (QingCloudServiceException e) {
            throw e;
